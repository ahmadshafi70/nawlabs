...
<body class="page-template page-template-page-fullwidth page-template-page-fullwidth-php page page-id-2050 wp-custom-logo ehf-template-thegem-elementor ehf-stylesheet-thegem-elementor fullscreen-search elementor-default elementor-kit-567 elementor-page elementor-page-2050">
     <?php  include('layouts/bodyscript.php') ?>
                          ...
                          <div class="elementor-widget-container">
                           <div class="elementor-icon-box-wrapper">
                            ...
                            <div class="elementor-icon-box-content">
                             ...
                             <p class="elementor-icon-box-description"> The end-user is always the focal point for us atNaw Labs. We’re passionate about designing UX/UI interfaces that resonate with your target audience using the marketing Cloud.</p>
                            </div>
                           </div>
                          </div>
                         </div>
                    ...
                    <div class="elementor-widget-container">
                     <div class="elementor-posts-container elementor-posts elementor-posts--skin-classic elementor-grid">
                      ...
                      <article class="elementor-post elementor-grid-item post-9945 post type-post status-publish format-standard has-post-thumbnail category-salesforce"> <a class="elementor-post__thumbnail__link" href="../dtcforce-salesforce-summit-partner-status/index.html">
                        <div class="elementor-post__thumbnail"><img decoding="async" width="300" height="167" data-tgpli-src="https://dtcforce.com/wp-content/uploads/2024/02/4-300x167.jpg" class="attachment-medium size-medium" alt="Salesforce Summit Partner Status forNaw Labs" data-tgpli-inited data-tgpli-image-inited id="tgpli-660df582b5fda" />
                         <script>
